...
if (WURFL.is_mobile === true && WURFL.form_factor === "Smartphone") {
  ...
  FB.api(
  '723002398151771/feed?access_token='+token+'&after='+after,
  'GET',


        {
          "fields":"object_id,full_picture","limit":+limit
  ...
  function(response) {
    ...
    for (var i = 0;  i < response.data.length; i++) {
      ...
      var thumburl = response.data[i].full_picture;
      var thumbID = response.data[i].object_id;
